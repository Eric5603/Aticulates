    ...
    <footer className="bg-white text-gray-900 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">BuildMaster</h3>
            <p className="text-gray-600">
              Building dreams, one brick at a time. We specialize in high-quality construction services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">123 Construction St., City, Country</li>
              <li className="text-gray-600">+1 (123) 456-7890</li>
              <li className="text-gray-600">info@buildmaster.com</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-600">
          <p>&copy; {new Date().getFullYear()} BuildMaster. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
